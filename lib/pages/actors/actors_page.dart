...
class ActorsPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    Provider((ref) {
      ref.listen<int>(_pageProvider, (_, int next) {
          ...
          children: [
            ...
            Expanded(
              child: PageView.builder(
                onPageChanged: (page) => Provider((ref) {
                  ref.read(_pageProvider.notifier).state = page;
                }),
                            ...
                            Container(
                              ...
                              decoration: BoxDecoration(
                                ...
                                image: person.profilePath != null
                                    ? DecorationImage(
                                        image: NetworkImage(
                                            person.profilePath!.path),
                                        fit: BoxFit.cover,
                                      )
                                    : null,
                                color: person.profilePath == null
                                    ? MovieColors.noImage
                                    : null,
                              ),
                            ),
